...
const util = {
	...
	mpvArguments: function(options, userInputArguments) {
		...
		// force_window option additional argument
		// --force-window  force creation of a video output window
		if(options.force_window){
			defaultArgs = [...defaultArgs, '--force-window'];
		}
