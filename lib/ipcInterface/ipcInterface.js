	...
	send: function(command) {
		return new Promise((resolve, reject) => {
			...
			if (this.socket.destroyed || !this.socket.writable){
				return reject(this.errorHandler.errorMessage(8, util.getCaller(), null, "Socket destroyed or not writable"));
			}
			...
			// reject the promise in case of an error
				...
				delete this.ipcRequests[request_id]; // 清理
				return reject(this.errorHandler.errorMessage(7, util.getCaller(), JSON.stringify(command), error.message));
			}
		})
